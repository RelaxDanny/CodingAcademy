...
pyame.mixer.music.play(-1) ###########################################################-1 mean to continuously play
...
##############################################################################################################################
    def hit(self): #다 초기화!!
        self.isJump = False
        self.jumpCount = 10
        self.x = 60 #when collision with enemy
        self.y = 410
        self.walkCount = 0
        ...
        i = 0
        while i < 100:
            pygame.time.dealy(10) # 1000 is 1 second -> 1 micro sec
            i += 1
